INSERT INTO departments (name, description) --departments?
VALUES
  ('Receptionist', ''),
  ('Sales', ''),
  ('Tech Support', '');

INSERT INTO employee (first_name, last_name, employee_id, job_titles departments, salaries)
VALUES --employees?
  ('Ronald', 'Firbank', 1, 1),
  ('Virginia', 'Woolf', 1, 1),
  ('Piers', 'Gaveston', 1, 0),
...
INSERT INTO voters (first_name, last_name, email) --What does this need to be refined into?
VALUES
